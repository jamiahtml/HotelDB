...
public class BillPage extends javax.swing.JFrame {
    ...
    public ArrayList<Bill> roomList(){
        ...
        try{
            ...
            Bill bill;
            while (rs.next()){
                bill = new Bill(rs.getString("res_num"),rs.getString("paid_on"),rs.getDouble("payment_amount"),rs.getString("cc_info"),rs.getString("guest_username"));
                billList.add(bill);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Reservation #", "Pay Date", "Cost", "CC #", "Guest Username"
            }
        ));
